...
public class HttpUtils {
    ...
    public static void readContentFromGet(String urlStr) throws IOException{
...
//        String getURL = GET_URL + "&activatecode=" + URLEncoder.encode("久酷博客", "utf-8");
	...
	public static void readContentFromPost(String urlStr) throws IOException{
...
//        out.close(); // flush and close
	...
	public static String getContent() throws IOException {
		...
		URL url = new URL("http://www.xici.net.co/nt/");
